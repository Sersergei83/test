...
class LiteralExpresion extends Expression
{
    private mixed $value;
...
$statement=new BooleanOrExpression(
    new BooleanEqualsExpression($input, new LiteralExpresion('четыре')),
    new BooleanEqualsExpression($input,new LiteralExpresion('4'))
);
foreach (["четыре","4","54"]as $val)
{
    $input->setValue($val);
    print "$val:\n";
